...
export const addReviewToDetails = async (detailsId, reviewId) => detailsModel.updateOne({ _id: detailsId }, { $push: { reviews: reviewId }});
export const removeReviewFromDetails = async (detailsId, reviewId) => detailsModel.updateOne({ _id: detailsId }, { $pull: { reviews: reviewId }});
